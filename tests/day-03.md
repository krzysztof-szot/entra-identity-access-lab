...
| CA001 enforcement is recorded in Sign-in logs | MFA succeeds and `CA001-ExpensePortal-Require-MFA` returns `Success` | Pass | [07-ca001-enforced-success.png](../evidence/day-03/07-ca001-enforced-success.png) |
...
The tests confirmed that staged Conditional Access deployment, MFA authentication strength, sign-in log validation and high-risk sign-in controls behave as designed.
