...
- [05 — Synchronization initialization](05-entra-connect-sync-success.png) — Entra Connect configuration and synchronization initialization completed successfully.
...
- [07 — Password synchronization test](07-password-hash-sync-test.png) — successful cloud authentication for the synchronized identity following the password synchronization test.
